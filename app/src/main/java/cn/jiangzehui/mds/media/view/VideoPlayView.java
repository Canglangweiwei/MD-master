...
import cn.jiangzehui.mds.media.IjkVideoView;
...
public class VideoPlayView extends RelativeLayout
    ...
    private void initViews() {
        ...
        View rView = LayoutInflater.from(mContext).inflate(R.layout.view_video_item, this, true);
    ...
    public void onChanged(Configuration configuration) {
        boolean portrait = configuration.orientation == Configuration.ORIENTATION_PORTRAIT;
