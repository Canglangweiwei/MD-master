...
public class JsoupUtil {
    ...
    private static ArrayList<String> list_dongtai = new ArrayList<>();
    private static ArrayList<String> list_xiegif = new ArrayList<>();
    private static ArrayList<String> list_gaoxiao = new ArrayList<>();
